...
### XDM is currently being re-written to be more user friendly and performant, please refer to (https://github.com/Mayanktaker/xdm/discussions/768) for more information ###
...
<details><summary>Optional debug log (only if <code>XDM_DEBUG_MODE=1</code> was enabled)</summary>
...
```bash
XDM_DEBUG_MODE=1 fetchflow   # or XDM_DEBUG_MODE=1 /opt/fetchflow/fetchflow
```

See also: https://github.com/Mayanktaker/xdm/wiki/Generate-log-for-troubleshooting

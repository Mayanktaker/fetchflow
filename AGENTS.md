...
| `dotnet app/XDM/XDM.Tests/bin/Release/net8.0/XDM.Tests.dll` | Run 65-test automated suite (MSTest, YDL parser, JSON, Glade wiring, Language, Branding, GTK smoke, single-instance policy, IPC resilience, failure reporting, SQLite migration) |
